...
public class AccountView extends View<AccountController> {
    ...
    private final InputWidget input = new InputWidget("Verander Wachtwoord", this.gap, Main.TASKBAR_SIZE + this.section + this.section / 2, Main.FRAME_SIZE - 64 - this.gap * 3, 32, 0, this.controller::setPassword);
